    ...
    return (
        ...
        {loader ?
            ...
            <div className='flex w-full items-center justify-center'>
                ...
                <div role="status">
                    <svg aria-hidden="true" class="w-4/6 h-4/6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-primary" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
